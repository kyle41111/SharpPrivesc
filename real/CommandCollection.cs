...
namespace Privesc.check
{
    public class CommandCollection
    {
        ...
        public CommandCollection()
        {
            ...
            _availableCommands.Add(nested.CommandName, () => new nested());
            _availableCommands.Add(unquoted.CommandName, () => new unquoted());
            _availableCommands.Add(Dcsync.CommandName, () => new Dcsync());
        }
